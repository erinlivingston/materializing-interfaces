...
// Expose helpers/classes to `globalThis` so ESM modules can access them.
// Top-level `class Riso` declarations are not automatically attached to `window`.
try {
  globalThis.Riso = Riso;
  globalThis.drawRiso = typeof drawRiso === "function" ? drawRiso : undefined;
  globalThis.exportRiso = typeof exportRiso === "function" ? exportRiso : undefined;
  globalThis.clearRiso = typeof clearRiso === "function" ? clearRiso : undefined;
  globalThis.ditherImage = typeof ditherImage === "function" ? ditherImage : undefined;
  globalThis.halftoneImage = typeof halftoneImage === "function" ? halftoneImage : undefined;
  globalThis.risoNoFill = typeof risoNoFill === "function" ? risoNoFill : undefined;
  globalThis.risoNoStroke = typeof risoNoStroke === "function" ? risoNoStroke : undefined;
} catch (_) {
  // best effort
}
